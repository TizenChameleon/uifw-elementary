...
static void utc_UIFW_elm_editfield_entry_get_func_01(void);
...
/**
 * @brief Positive test case of elm_editfield_entry_get()
 */
static void utc_UIFW_elm_editfield_entry_get_func_01(void)
{
	Evas_Object *r = NULL;

   	r = elm_editfield_entry_get(ef);
	if (!r) {
		tet_infoline("elm_editfield_entry_get() failed in positive test case");
		tet_result(TET_FAIL);
		return;
	}
	tet_result(TET_PASS);
...
/**
 * @brief Negative test case of ug_init elm_editfield_entry_get()
 */
static void utc_UIFW_elm_editfield_entry_get_func_02(void)
{
	Evas_Object *r = NULL;
