...
struct tet_testlist tet_testlist[] = {
	{ utc_UIFW_elm_controlbar_tab_item_insert_before_func_01, POSITIVE_TC_IDX },
	{ utc_UIFW_elm_controlbar_tab_item_insert_before_func_02, NEGATIVE_TC_IDX },
	{ NULL, 0 }
};
...
/**
 * @brief Positive test case of elm_controlbar_tab_item_insert_before()
 */
static void utc_UIFW_elm_controlbar_tab_item_insert_before_func_01(void)
{
