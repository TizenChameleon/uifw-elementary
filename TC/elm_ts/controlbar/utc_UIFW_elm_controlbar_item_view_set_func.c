...
struct tet_testlist tet_testlist[] = {
	{ utc_UIFW_elm_controlbar_item_view_set_func_01, POSITIVE_TC_IDX },
	{ utc_UIFW_elm_controlbar_item_view_set_func_02, NEGATIVE_TC_IDX },
	{ NULL, 0 }
};
...
/**
 * @brief Positive test case of elm_controlbar_item_view_set()
 */
static void utc_UIFW_elm_controlbar_item_view_set_func_01(void)
{
