...
/**
 * @brief Positive test case of elm_controlbar_mode_set()
 */
static void utc_UIFW_elm_controlbar_mode_set_func_01(void)
{
   	elm_controlbar_mode_set(controlbar, ELM_CONTROLBAR_MODE_DEFAULT);
   	elm_controlbar_mode_set(controlbar, ELM_CONTROLBAR_MODE_LARGE);
...
/**
 * @brief Negative test case of ug_init elm_controlbar_mode_set()
 */
static void utc_UIFW_elm_controlbar_mode_set_func_02(void)
{
   	elm_controlbar_mode_set(controlbar, NULL);
