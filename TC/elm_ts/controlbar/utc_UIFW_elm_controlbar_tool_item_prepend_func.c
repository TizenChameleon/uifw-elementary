...
struct tet_testlist tet_testlist[] = {
	{ utc_UIFW_elm_controlbar_tool_item_prepend_func_01, POSITIVE_TC_IDX },
	{ utc_UIFW_elm_controlbar_tool_item_prepend_func_02, NEGATIVE_TC_IDX },
	{ NULL, 0 }
};
...
/**
 * @brief Positive test case of elm_controlbar_tool_item_prepend()
 */
static void utc_UIFW_elm_controlbar_tool_item_prepend_func_01(void)
{
...
/**
 * @brief Negative test case of ug_init elm_controlbar_tool_item_prepend()
 */
static void utc_UIFW_elm_controlbar_tool_item_prepend_func_02(void)
{
	Elm_Controlbar_Item *item = NULL;
