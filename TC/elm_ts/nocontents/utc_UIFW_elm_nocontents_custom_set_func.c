...
static void utc_UIFW_elm_nocontents_custom_set_func_02(void);
...
struct tet_testlist tet_testlist[] = {
	{ utc_UIFW_elm_nocontents_custom_set_func_01, POSITIVE_TC_no_contents },
	{ utc_UIFW_elm_nocontents_custom_set_func_02, NEGATIVE_TC_no_contents },
};
...
/**
 * @brief Negative test case of elm_nocontents_custom_set()
 */
static void utc_UIFW_elm_nocontents_custom_set_func_02(void)
{
        Evas_Object *no_contents = NULL;
	...
	custom = elm_nocontents_custom_get(no_contents);
	if (custom) {
		tet_infoline("elm_nocontents_custom_set() failed in negative test case");
		tet_result(TET_FAIL);
		return;
	}
	tet_result(TET_PASS);
