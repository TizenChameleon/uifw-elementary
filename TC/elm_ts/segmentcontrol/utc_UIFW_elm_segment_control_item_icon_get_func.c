...
/**
 * @brief Positive test case of elm_segment_control_item_icon_get()
 */
static void utc_UIFW_elm_segment_control_item_icon_get_func_01(void)
{
   ...
   item = elm_segment_control_item_add(segment, ic, "All");
   icon = elm_segment_control_item_icon_get(segment,0);
   if (!icon) {
      tet_infoline("elm_segment_control_item_icon_get() failed in positive test case");
      tet_result(TET_FAIL);
      return;
   }
   tet_result(TET_PASS);
...
/**
 * @brief Negative test case of ug_init elm_segment_control_item_icon_get()
 */
static void utc_UIFW_elm_segment_control_item_icon_get_func_02(void)
{
   Elm_Segment_Item *item = NULL;
