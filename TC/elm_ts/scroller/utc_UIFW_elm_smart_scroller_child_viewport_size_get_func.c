...
static void utc_UIFW_elm_smart_scroller_child_viewport_size_get_func_01(void);
static void utc_UIFW_elm_smart_scroller_child_viewport_size_get_func_02(void);
...
struct tet_testlist tet_testlist[] = {
	{ utc_UIFW_elm_smart_scroller_child_viewport_size_get_func_01, POSITIVE_TC_IDX },
	{ utc_UIFW_elm_smart_scroller_child_viewport_size_get_func_02, NEGATIVE_TC_IDX },
	{ NULL, 0 }
};
...
/**
 * @brief Positive test case of elm_smart_scroller_child_viewport_size_get()
 */
static void utc_UIFW_elm_smart_scroller_child_viewport_size_get_func_01(void)
{
...
/**
 * @brief Negative test case of ug_init elm_smart_scroller_child_viewport_size_get()
 */
static void utc_UIFW_elm_smart_scroller_child_viewport_size_get_func_02(void)
{
	Evas_Object *scroll = NULL;
