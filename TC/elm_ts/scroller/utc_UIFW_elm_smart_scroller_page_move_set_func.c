...
static void utc_UIFW_elm_smart_scroller_page_move_set_func_01(void);
static void utc_UIFW_elm_smart_scroller_page_move_set_func_02(void);
...
struct tet_testlist tet_testlist[] = {
	{ utc_UIFW_elm_smart_scroller_page_move_set_func_01, POSITIVE_TC_IDX },
	{ utc_UIFW_elm_smart_scroller_page_move_set_func_02, NEGATIVE_TC_IDX },
	{ NULL, 0 }
};
...
/**
 * @brief Positive test case of elm_smart_scroller_page_move_set()
 */
static void utc_UIFW_elm_smart_scroller_page_move_set_func_01(void)
{
    ...
    elm_smart_scroller_page_move_set(scroll,1);			
	tet_result(TET_PASS);
}
...
static void utc_UIFW_elm_smart_scroller_page_move_set_func_02(void)
{
	...
	evas_object_resize(scroll,240,400);
	evas_object_resize(entry,240,400);
    elm_smart_scroller_page_move_set(NULL,1);			
	tet_result(TET_PASS);
}
