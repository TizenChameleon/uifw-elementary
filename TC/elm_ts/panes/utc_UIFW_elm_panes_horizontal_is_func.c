...
struct tet_testlist tet_testlist[] = {
	{ utc_UIFW_elm_panes_horizontal_is_func_01, POSITIVE_TC_IDX },
	{ utc_UIFW_elm_panes_horizontal_is_func_02, NEGATIVE_TC_IDX },
	{ NULL, 0 }
};
...
/**
 * @brief Positive test case of elm_panes_horizontal_is()
 */
static void utc_UIFW_elm_panes_horizontal_is_func_01(void)
{
...
/**
 * @brief Negative test case of ug_init elm_panes_horizontal_is()
 */
static void utc_UIFW_elm_panes_horizontal_is_func_02(void)
{
   Evas_Object *panes = NULL;
